...
const InputSchema = z.object({
  [key: string]: number, // Allow any key but the value must be a number
});

export type InputStoreState = Readonly<z.infer<typeof InputSchema>>;

type SetInputAction = (name: keyof InputStoreState, value: number) => void;
