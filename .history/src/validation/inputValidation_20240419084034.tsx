...
export const validationSchema = zod.object().shape({
  initialCashBalance: zod.number().positive().required("Cash balance is required"),
  currentCashBalance: zod.number().positive().required("Current cash balance is required"),
  monthlyIncome: zod.number().positive().required("Monthly income is required"),
