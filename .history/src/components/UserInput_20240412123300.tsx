...
const UserInput = () => {
  ...
  // const setinitialCashBalance = useInputStore((state:any) => state.setField( 'initialCashBalance': state.initialCashBalance))
  const setInitialCashBalance = useInputStore((state:any) =>
    state.setField("initialCashBalance", state.initialCashBalance)
  );
