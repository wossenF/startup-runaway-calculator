...
import { handleInputChange } from '../validation/inputValidation';
...
const UserInput = () => {
  ...
  const handleInitialCashBalanceChange = handleInputChange('initialCashBalance', setField, setErrors);
  [showCostOfGoodsSold, setShowCostOfGoodsSold] = useState(false);
