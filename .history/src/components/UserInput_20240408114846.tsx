    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
      ...
      <div className="bg-secondary/50 rounded-lg p-7  ">
        <form className="grid gap-2">
          ...
          <div className="flex justify-between p-3 gap-20 border rounded-md bg-slate-200  ">
            <p>Cost of good </p>
            <ChevronDown />
          </div>
          <div className="flex justify-between p-3 gap-20 border rounded-md bg-slate-200  ">
          ...
          <div className="flex justify-between p-3 gap-20 border rounded-md bg-slate  ">
            <p>Expense Reduction</p>
            <ChevronDown />
          </div>
          <div className="flex justify-between p-3 gap-20 border rounded-md bg-slate-100  ">
            <p>Fundraising</p>
            <ChevronDown />
          </div>
        </form>
