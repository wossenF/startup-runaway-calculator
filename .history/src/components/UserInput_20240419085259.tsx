...
import { validationSchema, handleInitialCashBalanceChange } from "../validation/inputValidation";
          ...
          <div className="cash-balance bg-secondary/50 rounded-lg p-7">
            <form className="grid gap-2">
              ...
              <Input
                ...
                onChange={handleInitialCashBalanceChange(setField)}
              />
              {/* Display validation error */}
              {validationSchema.shape?.initialCashBalance &&
                validationSchema.shape?.initialCashBalance?.error && (
