...
import { InputSchema, InputData } from "../validation/inputValidation";
const UserInput = () => {
  ...
  const handleCalculateRunawayClick = (event: MouseEvent) => {
    ...
    const validationResult = InputSchema.safeParse(inputState);

    if (validationResult.success) {
      // Proceed with further actions, e.g., calculating runaway
  ...
  return (
    <>
      ...
      <Button type="submit" onClick={const handleCalculateRunawayClick = (event: MouseEvent) => {
    event.preventDefault();
    setIsClicked(true);
