...
const UserInput = () => {
  ...
  return (
    <>
      ...
      let runwayMonths = 0; let monthlyExpense=payroll + nonPayroll let
      initialCashBalance=cashBalance-monthlyExpense let
      monthlyRevenue=monthlyIncome*(GrowthRate)+ initialCashBalance let
      GrossProfit=monthlyRevenue-cogsPercentage let netIncome = GrossProfit -
      monthlyExpense cashBalance += netIncome cashBalance += fundraisingAmount
