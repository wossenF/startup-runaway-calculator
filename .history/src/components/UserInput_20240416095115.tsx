...
const UserInput = () => {
  ...
  //       setField(field, parseFloat(value));
  //       // If successfully parsed, clear any previous errors for this field
  ...
  //     setErrors((prevErrors) => ({ ...prevErrors, [field]: "Please enter a valid number" }));
  //   }
  // };
