...
const UserInput: React.FC = () => {
  ...
  const handleInputChange = (fieldName: keyof InputStoreState) => (e: React.ChangeEvent<HTMLInputElement>) => {
  ...
  const validateField = async (fieldName: keyof InputStoreState, value: any) => {
    try {
        ...
        <div className="cash-balance bg-secondary/50 rounded-lg p-7">
          <form className="grid gap-2">
            ...
            <Input
              ...
              onChange={handleInputChange("initialCashBalance")}
              onError={(errorMessage) => setErrors({ "initialCashBalance": errorMessage.target.value })}
        />
