...
export default function Home() {
  ...
  return (
    <main className="w-3/4 m-12">
      ...
      <p className="pb-10 mx-auto max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl p-3 pl-0">
      ...
      <button className="bg-[#13213C] text-primary-foreground hover:bg-primary/90 p-3" onClick={handleClick}>
