...
export function calculateRunway(userInput: InputStoreState): string | number {
...
export function calculateProjectedRevenue(userInput: InputStoreState, months: number): { month: number; revenue: number }[] {
